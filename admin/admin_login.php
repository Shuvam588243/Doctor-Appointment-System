...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <a class="navbar-brand" href="../index">HEALTH PLUS</a>
...
<form method="post">
  ...
  <h2 align="center" style="color:red"> Admin Login Panel </h2>
  <br><br>
  <fieldset>
...
$query="Select * from admin where Admin_id='$t1' and Admin_pass='$t2'";
