...
<form method="post">
  <fieldset>
	...
	<div class="form-group">
      ...
      <input type="text" name="t4" class="form-control" id="exampleInputAddress" aria-describedby="emailHelp" value="" >
    ...
    <button type="submit" name="submit2" class="btn btn-primary">Postpone</button>
  </fieldset>
...
$id=$_POST["t1"];
	 ...
	 $query = "UPDATE appointment SET Approval= 'Postponed' , ap_date='$t4' where ap_id='$id'"; 
		$data = mysqli_query($conn, $query);
		if($data)
		{
		echo "<marquee> Date Postponed Successfully......the new date is $t4 </marquee>";
		}
		else{
