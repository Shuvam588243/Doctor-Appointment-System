...
$query="select * from patient where PEmail='$ids'";
  ...
  <fieldset>
   ...
   <h3 align="center" style="color:red"> Online Doctor Appointment Panel </h3>
	...
	<div class="form-group">
      ...
      <input type="text" name="t2" class="form-control" id="exampleName" aria-describedby="emailHelp" value="<?php echo "$t12" ?>">
      
    </div>
	
	<div class="form-group">
      <label for="exampleInputEmail1">Email</label>
      <input type="email" name="t11" class="form-control" id="exampleName" aria-describedby="emailHelp" value="<?php echo "$t13" ?>">
      
    </div>
	
	<div class="form-group">
      <label for="exampleInputEmail1">Date</label>
      <input type="date" name="t3" class="form-control" id="exampleName" aria-describedby="emailHelp" >
